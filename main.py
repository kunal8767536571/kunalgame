...
walkRight = [pygame.image.load(join('pics', 'NR2.png')),pygame.image.load(join('pics', 'NR3.png')),pygame.image.load(join('pics', 'NR1.png'))]
walkLeft = [pygame.image.load(join('pics', 'NL2.png')),pygame.image.load(join('pics', 'NL3.png')),pygame.image.load(join('pics', 'NL1.png'))]

bg = pygame.image.load(join('pics', 'bg.png'))
stan = pygame.image.load(join('pics', 'Nstanding.png'))

Nh = pygame.image.load(join('pics', 'Nh.png'))
Sh = pygame.image.load(join('pics', 'Sh.png'))

theme = pygame.mixer.music.load(join('pics', 'theme.mp3'))
	...
	def draw(self,win):
		...
		if self.health >0:
			...
			if not(self.standing):
				...
				if self.right:
					win.blit(pygame.image.load(join('pics', 'NR1.png')), (self.x, self.y))
				else:
					win.blit(pygame.image.load(join('pics', 'NL1.png')), (self.x, self.y))
			...
			win.blit(pygame.image.load(join('pics', 'Nd.png')),(self.x,self.y))	
...
class weapons():
	...
	def draw(self,win):
		win.blit(pygame.image.load(join('pics', 'shur.png')),(self.x,self.y))
...
class enemy():
	...
	walkRightS = [pygame.image.load(join('pics', 'SR2.png')),pygame.image.load(join('pics', 'SR3.png')),pygame.image.load(join('pics', 'SR1.png'))]
	walkLeftS = [pygame.image.load(join('pics', 'SL2.png')),pygame.image.load(join('pics', 'SL3.png')),pygame.image.load(join('pics', 'SL1.png'))]
	...
	def draw(self, win):
		...
		if self.health >0:
			...
			win.blit(text,(180,200))
			win.blit(pygame.image.load(join('pics', 'Sd.png')),(self.x,self.y))
		#pygame.draw.rect(win, (255,0,0),self.hitbox,2)
